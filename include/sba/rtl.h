...
namespace SBA {
   ...
   class RTL {
    ...
    public:
      ...
      /* helper */
      /* STRICT:  identical                      相同               */     
      /* RELAXED: similar, ignore mode           类似，忽略模式                */
      /* PARTIAL: similar, ignore mode, support arbitrary parts   类似，忽略模式，支持任意部分  */
      /* OPCODE:  same opcode or ANY opcode      相同操作码或任意操作码            */
   ...
   class Assign: public Statement {
    ...
    public:
      ...
      void Execute_ASSIGN(State& state);                                               
